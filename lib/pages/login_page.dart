    ...
    return Scaffold(
      body: Container(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center, // Колонка с прилиганием по центру
            children: [
              // ... (Добавьте логотип или заголовок, если нужно)
              ...
              const TextField(
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(20)),  // Радиус закругления
              ...
              // Кнопка "Войти"
              ElevatedButton(
                onPressed: () {// ... (Обработка входа/регистрации)
